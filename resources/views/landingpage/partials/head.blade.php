...
<title>HOME SERVICE ELECTRONIC - Jasa Service Elektronik Malang Raya</title>
<meta name="description"
    content="Kami menyediakan jasa service elektronik terbaik di Malang Raya, melayani berbagai kebutuhan perbaikan dan perawatan perangkat elektronik Anda dengan harga terjangkau dan profesional.">
<meta name="keywords"
    content="jasa service elektronik, Malang Raya, service elektronik murah, perbaikan elektronik Malang, jasa elektronik profesional, reparasi elektronik Malang Raya">
...
<style>
    :root {
        --dynamic-accent-color: #417abb;
    }
</style>
{{-- 
<style>
    :root {
        --dynamic-accent-color: {{ $dynamicAccentColor }};
    }
</style> --}}
